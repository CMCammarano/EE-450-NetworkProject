...
Patient2::Patient2() : m_state(IDLE) {}
Patient2::~Patient2() {}

void Patient2::initialize() {

	// Load patient information
	std::ifstream input;
	input.open("Input/patient2.txt");
	...
	insurance.open("Input/patient2insurance.txt");
...
void Patient2::shutdown() {}

bool Patient2::update() {
	...
	switch (m_state) {
		...
		case IDLE: {
			...
			std::cout << "Phase 1: Patient 2 has TCP port number " << s->sin_port << " and IP address " << ipAddress << "." << std::endl;
			std::cout << std::endl;
			...
			std::cout << "Phase 1: Authentication request from Patient 2 with username " << m_name << " and password " << m_password << " has been sent to the Health Center Server." << std::endl;
			std::cout << std::endl;
			...
			std::cout << "Phase 1: Patient 2 authentication result: " << result << "." << std::endl;
			std::cout << std::endl;
			...
			std::cout << "Phase 1: End of Phase 1 for Patient2." << std::endl;
			std::cout << std::endl;
			break;
		}
		...
		case LOGGING_IN: {
			...
			std::cout << "Phase 2: The following appointments are available for Patient 2: " << std::endl;
			std::cout << std::endl;
			...
			if (apt_temp == "notavailable") {
				std::cout << "Phase 2: The requested appointment from Patient 2 is not available. Exiting..." << std::endl;
				std::cout << std::endl;
				m_state = FINISHED;
				break;
			}
			...
			std::cout << "Phase 2: The requested appointment is available and reserved to Patient2. The assigned doctor port number is " << m_doctorPort << std::endl;
			std::cout << std::endl;
		...
		case SPEAKING_TO_DOCTOR: {
			...
			// Get basic system information and create connection to doctor assigned in previous step.
			addrinfo hints;
			addrinfo* addressInfo;
			...
			std::cout << "Phase 3: Patient 2 has dynamic UDP port number " << s->sin_port << " and IP address " << ipAddress << "." << std::endl;
			std::cout << std::endl;
			...
			insurance += " ";
			insurance += pt;
			std::cout << "Phase 3: The cost estimation request from Patient 2 with insurance plan " << m_insurance << " has been sent to the doctor with port number " << m_doctorPort << " and IP address " << ipAddress << "." << std::endl;
			std::cout << std::endl;
			...
			m_state = FINISHED;
			std::cout << "Phase 3: End of Phase 3 for Patient2." << std::endl;
			std::cout << std::endl;
			break;
		}
...
// Entry point for patient 2 process
